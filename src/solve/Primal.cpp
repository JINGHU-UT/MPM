...
//! Either log directly residual, or re-evaluate it using another complementarity func
...
void Primal::SolverStats::log( unsigned iter, Scalar res, Scalar time )
{
	...
	mpm::Log::Debug() << "Primal " << iter << " =\t " << res << std::endl ;
