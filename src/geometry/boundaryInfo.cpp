...
namespace mpm{
  ...
  void BoundaryInfo::combine( const Bc bc_, const Vec3 n )
  {
  ...
  void BoundaryInfo::stressProj( Mat6 &proj ) const
  {
    proj.setIdentity() ;
  ...
  void BoundaryInfo::spinProj(Mat3 &proj) const{
    proj.setIdentity() ;
  }
  ...
  StrBoundaryMapper::StrBoundaryMapper(const std::string &str)
  {
    ...
    std::istringstream iss( parse_str ) ;
    std::string line ;
